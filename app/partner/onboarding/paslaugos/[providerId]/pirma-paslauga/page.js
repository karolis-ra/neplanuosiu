...
export default function FirstServiceOnboardingPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      console.error("create first service error:", e);
      setErrorMsg("Nepavyko sukurti paslaugos. Bandykite dar kartą.");
    } finally {
      setSubmitting(false);
    }
  }
    ...
    <main className="mx-auto max-w-[900px] px-[16px] py-[40px]">
      <div className="mb-[24px]">
        ...
        <p className="mt-[12px] ui-font text-[15px] leading-[24px] text-slate-600">
          Sukurkite pirmą pasiūlymą savo profiliui. Vėliau galėsite pridėti
          daugiau paslaugų, nuotraukų ir darbo laiką.
        </p>
        {provider && (
